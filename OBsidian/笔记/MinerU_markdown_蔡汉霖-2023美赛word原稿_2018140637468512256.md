...
- $u(t)$：CPU 利用率/负载率 (CPU utilization, $u(t) \in [0, 1]$)
    
- $\kappa_{soc}$：能效系数，反映 3nm 工艺下的能效特征 (Efficiency coefficient)
    

> **模型验证 (Apple A17 Pro)：**
> 
> $$P_{cpu}(t) = 0.55 + 0.21 \cdot f(t)^3 \cdot u(t)$$
> 
> _(注：此处 $f(t)$ 的立方项符合 CMOS 数字电路中功率与电压平方及频率成正比的物理特性)_