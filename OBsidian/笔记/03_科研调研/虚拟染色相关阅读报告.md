# 1 .综述：
**下面是一些论文主要讲的内容，我会稍微总结一下最后给出就是哪一些方面是已经做过的，目前没办法做的：**
...
## COCODIFF: CORRESPONDENCE-CONSISTENT DIFFU- SION MODEL FOR FINE-GRAINED STYLE TRANSFER


文章链接
[[CoCoDiff Correspondence-Consistent Diffusion Model for Fine-grained Style Transfer.pdf]]
文章核心内容：
COCODIFF：细粒度样式迁移的对应一致性扩散模型


## Unpaired Multi-Domain Histopathology Virtual Staining using Dual Path